...
<section>
    ...
    <div class="container">
        ...
        <?php if(isset($_GET['id'])){ ?>
            <div class="row">
                <a class="mt-5 btn btn-success mx-auto" href="registerStep.php?id=<?php echo $LastRecipe->getId(); ?>">La premiere étape</a>
            </div>
            <?php }else{?>
        <form class="p-5 mt-3 col-12 mx-auto d-flex flex-column" action="registerRecipe.php?id=" method="post" enctype="multipart/form-data">
