...
<hr>
                ...
                <div id="input_ingredients">
                   <div id="parent-1" class="form-group row mx-auto  col-md-12">
                            <input class="col-md-3 form-control" type="text" name="recipe-ingredien-quantity" placeholder="Quantité">
                            <span class="mt-2 mx-2">de</span>
                            <input class="col-md-6 form-control" type="text" name="recipe-ingredien" placeholder="Ingrédient">
