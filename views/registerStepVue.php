...
<section>
    <div class="container">
        ...
        <form class="p-5" action="registerStep.php?id=<?php echo $LastRecipe->getId(); ?>" method="post">
        ...
        <div class="row">
                 <a class="btn mx-auto mt-5 btn-info" href="registerIngredient.php?id=<?php echo $LastRecipe->getId(); ?>">Ajouter vos ingredients</a>
            </div>
    </div>
</section>
<?php
